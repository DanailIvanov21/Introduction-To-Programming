...
**9.** Да се напише функция, която приема стринг и връща два нови стринга Х и У такива, че Х съдържа само главните букви от зададения стринг, а У - само малките букви. Останалите букви да се игнорират. Масивите за Х и У да са с точна големина.
Вход:
```c++
...
**10.** Да се напише функция, която обединява два сортирани масива, като резултатния масив остава сортиран. Последния да е заделен динамично с точна големина.
