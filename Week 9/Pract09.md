...
А- дресите се записват като цели шестнайсетични числа
...
## Задача 12: Да се напише функция, която приема стринг и връща два нови стринга X и Y такива че:
...
## Задача 13: Да се напише функция, която филтрира всички прости числа от зададен динамичен масив. Масивът да се преоразмери с точна големина!
...
## Задача 14: Да се напише функция, която обединява два сортирани динамични масива, като резултатният масив остава сортиран. Последният да е с точна големина!
